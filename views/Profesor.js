...
export default class Profesor extends React.PureComponent{
  constructor(props){
    super(props)
    //Ahora definimos las variables para la tabla profesor
...
//Ahora vamos a codificar la función ListarxId para
  ...
  ListarProfesorxId = () => {
    ...
    fetch('https://localhost:44351/Api/Profesor', {
        ...
        body: JSON.stringify({
          profesor_id: this.state.TextInput_id,
          profesor_nif: this.state.TextInput_nif,
          profesor_nombre: this.state.TextInput_nombre,
          profesor_apellido1: this.state.TextInput_apellido1,
          profesor_apellido2: this.state.TextInput_apellido2,
          profesor_ciudad: this.state.TextInput_ciudad,
          profesor_clave: this.state.TextInput_clave,
          profesor_direccion: this.state.TextInput_direccion,
          profesor_telefono: this.state.TextInput_telefono,
          profesor_fecha_nacimiento: this.state.TextInput_fecha_nacimiento,
          profesor_sexo: this.state.TextInput_sexo,
          profesor_tipo: this.state.TextInput_tipo        
        })
      }
    ).then((response) => response.json())
    .then((responseJson) => {
